 ...
 * Displays an always-visible Google Map with GPS markers from project media.
 * All overlay logic has been removed — overlays are handled exclusively by MapboxOverlayView.
 */

...
## Final Report Preview UI Fixes (Feb 28, 2026)
- [x] Increase modal height to max-h-[98vh] for maximum screen usage
- [x] Make preview content flexible (flex-1) instead of fixed height
- [x] Fix "Back to Report Options" button visibility (ghost → outline variant)
- [x] Add proper spacing between buttons (gap-4, mt-6, pt-4, border-t)
- [x] Push Print button to right with ml-auto
- [x] Remove "Generated by SkyVee" footer text from report HTML
- [x] Apply same fixes to FlightReportDialog for consistency

## Report Preview UI Issues - Round 2 (Feb 28, 2026)
- [ ] Fix modal height - currently too tall and cutting off at bottom
- [ ] Make "Back to Report Options" button visible in lower left
- [ ] Change report text color to white for better visibility
- [ ] Move client logo to right side (not centered) in report preview
- [ ] Set default media image quality selection to Medium
- [ ] Add padding between Print button and edge of page
- [ ] Change Print button styling to white border (remove green background)

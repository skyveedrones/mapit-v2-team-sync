...
## Video Spacing & Partner Logos
- [x] Fix video section spacing with leading-[0] on parent
- [x] Add block display to video element
- [x] Restore bottom gradient (h-32) for smooth transitions
- [x] Add leading-normal to content layer
